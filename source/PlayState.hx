...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, LanguageFile.getPhrase("playstate.botplay"), 32);
	...
	{
		scoreTxt.text = '${LanguageFile.getPhrase("playstate.score_text")}: ' + songScore;
