...
class ClientPrefs {
	...
	public static function saveSettings() {
		...
		save.bind('controls_v2', 'Kyanite'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
